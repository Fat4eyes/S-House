  ...
  <div className="col-xs-6 col-sm-5 col-md-5 col-lg-5 header__menu">
    <ul className="header__menu-list">
      <li className="header__menu-item">
        <a href="#" className="header__menu-item-link" onClick={() => renderPage(<Home/>)}>Главная</a>
      </li>
      <li className="header__menu-item">
        <a href="#" className="header__menu-item-link" onClick={() => renderPage(<Auth/>)}>Авторизация</a>
      </li>
      <li className="header__menu-item">
        <a href="#" className="header__menu-item-link" onClick={() => renderPage(<React.Fragment/>)}>Устройства и
          Датчики</a>
      </li>
    </ul>
  </div>
